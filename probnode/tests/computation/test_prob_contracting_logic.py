...
@pytest.mark.parametrize(
    ("input", "expect"),
    [([p__X(ES(Outcome("sample"))),
       AdditiveInverseP(ES(Outcome("sample")))], ProbabilityMeasure(None, 0)),
     ([
         p__X(ES(Outcome("sample1"))) + p__X(ES(Outcome("sample2"))),
         AdditiveInverseChainP.from_P(p__X(ES(Outcome("sample1"))) + p__X(ES(Outcome("sample2"))))
...
@pytest.mark.parametrize(
    ("input", "expect"),
    [([p__X(ES(Outcome("sample"))), ReciprocalP(ES(Outcome("sample")))
       ], ProbabilityMeasure(None, 1)),
     ([
         p__X(ES(Outcome("sample1")) & ES(Outcome("sample2"))),
         ReciprocalP.from_P(p__X(ES(Outcome("sample2"))))
         ], p__X(ES(Outcome("sample1")) // ES(Outcome("sample2")))),
     ([p__X(ES(Outcome("sample1"))), p__X(ES(Outcome("sample2")))
       ], p__X(ES(Outcome("sample1")) & ES(Outcome("sample2"))))]
    )
...
def test_is_or_probability_pattern():
  assert is_or_probability_pattern(
      p__X(ES(Outcome("x"))), p__X(ES(Outcome("y"))),
      p__X(ES(Outcome("x")) & ES(Outcome("y"))).additive_invert()
      ) == True
  assert is_or_probability_pattern(
      p__X(ES(Outcome("x"))), p__X(ES(Outcome("yyyy"))),
      p__X(ES(Outcome("x")) & ES(Outcome("y"))).additive_invert()
      ) == False
  assert is_or_probability_pattern(
      p__X(ES(Outcome("x"))), p__X(ES(Outcome("yyyy"))), p__X(ES(Outcome("x")) & ES(Outcome("y")))
      ) == False
...
def test_try_contract_or_probability_pattern():
  assert try_contract_or_probability_pattern(
      p__X(ES(Outcome("x"))), p__X(ES(Outcome("y"))),
      p__X(ES(Outcome("x")) & ES(Outcome("y"))).additive_invert()
      ) == p__X(ES(Outcome("x")) | ES(Outcome("y")))
  assert try_contract_or_probability_pattern(
      p__X(ES(Outcome("x"))), p__X(ES(Outcome("yyyy"))),
      p__X(ES(Outcome("x")) & ES(Outcome("y"))).additive_invert()
      ) == None
