...
def test_expand_simple_prob_exp(simple_prob_expression1: SimpleEventSet):
  assert expand(p__X(simple_prob_expression1))[0] == p__X(simple_prob_expression1)
...
def test_expand_invert_prob_exp(
  ...
  assert expand(p__X(simple_invert_prob_expression1)
                )[0] == (p__X(ES(GenericSureEventSet())) - p__X(simple_prob_expression1))
...
def test_expand_and_prob_exp(
  ...
  assert expand(p__X(and_prob_expression))[0] == (
      p__X(simple_prob_expression1 // simple_prob_expression2) * p__X(simple_prob_expression2)
      )
  assert expand(p__X(and_prob_expression))[1] == (
      p__X(simple_prob_expression2 // simple_prob_expression1) * p__X(simple_prob_expression1)
      )
...
def test_expand_or_prob_exp(
  ...
  assert expand(p__X(or_prob_expression))[0] == (
      p__X(simple_prob_expression1) + p__X(simple_prob_expression2) - p__X(and_prob_expression)
      )
...
def test_expand_conditional_prob_exp(
  ...
  assert expand(p__X(conditional_prob_expression)
                )[0] == (p__X(and_prob_expression) / p__X(simple_prob_expression2))
...
def test_expand_complex_prob_exp_chain(
  ...
  assert expand(p__X(and_prob_expression) + p__X(simple_prob_expression1))[0] == (
      p__X(simple_prob_expression1 // simple_prob_expression2) * p__X(simple_prob_expression2) +
      p__X(simple_prob_expression1)
      )
  assert expand(p__X(and_prob_expression) - p__X(simple_prob_expression1))[1] == (
      p__X(simple_prob_expression2 // simple_prob_expression1) * p__X(simple_prob_expression1) -
      p__X(simple_prob_expression1)
      )
  assert expand(p__X(and_prob_expression) / p__X(simple_prob_expression1))[1] == (
  ...
  assert expand(p__X(and_prob_expression) + p__X(simple_prob_expression1.invert()))[1] == (
      p__X(simple_prob_expression2 // simple_prob_expression1) * p__X(simple_prob_expression1) +
      p__X(ES(GenericSureEventSet())) - p__X(simple_prob_expression1)
      )
