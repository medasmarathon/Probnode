...
def test_remove_or_event_pattern_Ps_from_classified_lists():
    ...
    assert remove_or_event_pattern_Ps_from_classified_lists([p_x],
...
def test_remove_negating_Ps_from_classified_lists():
    ...
    assert remove_negating_Ps_from_classified_lists([p_y], [inverted_p_x, inverted_p_y]) == ([], [
        inverted_p_x
        ])
...
def test_remove_complement_Ps_from_classified_lists():
    ...
    assert remove_complement_Ps_from_classified_lists(2, [p_1, p_1],
                                                      [p_not_y.additive_invert()
                                                       ]) == (1, [p_1, p_1, p_y], [])
...
def test_contract_arbitrary_sum_P_group():
    ...
    assert contract_arbitrary_sum_P_group([
        p_1, p_x, p_x.additive_invert(),
        p_x.additive_invert(), p_y
        ]) == [p_y, p_not_x]
    assert contract_arbitrary_sum_P_group([
        p_1, p_x,
        p_x.additive_invert(),
...
def test_replace_reciprocal_Events_vs_AndEvent_lists_with_ConditionalEvent():
    ...
    assert replace_reciprocal_Events_vs_AndEvent_lists_with_ConditionalEvent([event_x],
                                                                             []) == ([event_x], [])
    assert replace_reciprocal_Events_vs_AndEvent_lists_with_ConditionalEvent([], [event_x_and_y
                                                                                  ]) == ([], [
                                                                                      event_x_and_y
                                                                                      ])
    assert replace_reciprocal_Events_vs_AndEvent_lists_with_ConditionalEvent([event_x],
...
def test_simplify_Ps_of_ConditionalEvent_from_classified_lists():
    ...
    assert simplify_Ps_of_ConditionalEvent_from_classified_lists([p_x_and_y], [
        p_y.reciprocate(), p_x.reciprocate(),
        p_z.reciprocate()
    ...
    assert simplify_Ps_of_ConditionalEvent_from_classified_lists([p_x_and_y], [
        p_x.reciprocate(), p_x.reciprocate(),
        p_y.reciprocate()
