        ...
        for idx, children_events in enumerate(children_of_and_event_list[:]):
            if normal_event in children_events:
                ...
                if len(children_events) == 0:
                    ...
                    normal_event_list.append(
                        and_event_list[idx].base_event | and_event_list[idx].aux_event
                        )
...
def contract_arbitrary_product_P_group(
    ...
    (normal_Ps,
     reciprocal_Ps) = remove_reciprocal_Ps_from_classified_lists(normal_Ps, reciprocal_Ps)
    if len(reciprocal_Ps) == 0 or len(normal_Ps) == 0:
    ...
    (normal_Ps, reciprocal_Ps
     ) = simplify_Ps_of_ConditionalEvent_from_classified_lists(normal_Ps, reciprocal_Ps)
...
def contract_reciprocated_Ps(product: ProductP) -> ProductP:
  ...
  """
    ...
    (float_value, normal_product_Ps,
     reciprocal_Ps) = _split_float_vs_normal_vs_reciprocal_Ps(P_list)
    (normal_product_Ps,
